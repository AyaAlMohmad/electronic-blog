                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.posts.show', $post->id) }}"
                                            class="btn btn-sm btn-outline-primary" title="@lang('admin.posts.approved.actions.view')">
                                        ...
                                        <form action="{{ route('admin.posts.approve', $post->id) }}" method="POST"
                                            ...
                                            <button type="submit" class="btn btn-sm btn-outline-success"
                                                title="@lang('admin.posts.approved.actions.approve')" onclick="return confirm('@lang('admin.posts.approved.actions.confirm_approve')')">
                                        ...
                                        {{-- <form action="{{ route('admin.posts.reject', $post->id) }}" method="POST"
                                            ...
                                            <button type="submit" class="btn btn-sm btn-outline-warning"
                                                title="@lang('admin.posts.approved.actions.reject')" onclick="return confirm('@lang('admin.posts.approved.actions.confirm_reject')')">
                                        ...
                                        <form action="{{ route('admin.posts.destroy', $post->id) }}" method="POST"
                                            ...
                                            <button type="submit" class="btn btn-sm btn-outline-danger"
                                                title="@lang('admin.posts.approved.actions.delete')" onclick="return confirm('@lang('admin.posts.approved.actions.confirm_delete')')">
